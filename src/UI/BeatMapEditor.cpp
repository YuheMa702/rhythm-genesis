...
//             spdlog::info("Playing audio...");
//             sound.play();
//             playPauseButton->setText("Pause");
//             isPlaying = true;
//         } else if (sound.getStatus() == sf::Sound::Playing) {
//             spdlog::info("Pausing audio...");
//             sound.pause();
//             playPauseButton->setText("Play");
//             isPlaying = false;
//         }
...
// void BeatMapEditor::safeSeek(float newProgress) {
//     if (buffer.getDuration().asSeconds() <= 0) return;
